...
let getCityCoordinates = function(city) {
    let weatherAPI = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=4edd5c67bad039e65d1609fc75835f07";
...
let getWeatherInfo = function(coordinates, cityName) {
    let oneCallApi = "https://api.openweathermap.org/data/2.5/onecall?" + coordinates
     + "&units=imperial&appid=4edd5c67bad039e65d1609fc75835f07"
